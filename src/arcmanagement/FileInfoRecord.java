 ...
 * @author lsola
 */
public class FileInfoRecord implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 881376942053019474L;
	...
	FileInfoRecord(File origFile, File textFile, String nomeNoEstensione, String estensione, String origPath) {
		this.origFile = origFile;
		this.textFile = textFile;
		this.instant = System.currentTimeMillis();
		this.nameNoExtension = nomeNoEstensione;
